...
export const categories = [
    {
        ...
        tools: [
            ...
            { id: 'jwt-decoder', name: 'JWT Decoder', icon: 'key', subtitle: 'Baca header & payload JWT.' },
            { id: 'background-remover', name: 'Background Remover', icon: 'image-minus', subtitle: 'Hapus latar belakang foto.' },
            { id: 'timezone-converter', name: 'Timezone Converter', icon: 'globe', subtitle: 'Konversi waktu antar zona.' },
            { id: 'age-calculator', name: 'Age Calculator', icon: 'cake', subtitle: 'Hitung umur presisi.' },
            { id: 'audio-recorder', name: 'Audio Recorder', icon: 'mic', subtitle: 'Rekam suara dari browser.' },
            { id: 'screen-recorder', name: 'Screen Recorder', icon: 'monitor', subtitle: 'Rekam layar langsung.' },
            { id: 'video-to-gif', name: 'Video to GIF', icon: 'file-video', subtitle: 'Ubah video jadi GIF.' },
            { id: 'svg-to-png', name: 'SVG to PNG', icon: 'image', subtitle: 'Konversi SVG ke PNG.' },
            { id: 'favicon-generator', name: 'Favicon Generator', icon: 'sparkles', subtitle: 'Buat favicon dari teks.' },
            { id: 'html-minifier', name: 'HTML Minifier', icon: 'code', subtitle: 'Kecilkan ukuran HTML.' },
            { id: 'url-encode-decode', name: 'URL Encode/Decode', icon: 'link', subtitle: 'Encode & decode URL.' },
            { id: 'random-generator', name: 'Random Generator', icon: 'shuffle', subtitle: 'Angka acak, dadu, pilihan.' },
            { id: 'color-contrast-checker', name: 'Color Contrast', icon: 'contrast', subtitle: 'Cek kontras warna WCAG.' },
            { id: 'csv-to-sql', name: 'CSV to SQL', icon: 'database', subtitle: 'Hasilkan query INSERT.' },
            { id: 'calculator', name: 'Calculator', icon: 'calculator', subtitle: 'Kalkulator cepat.' },
        ]
    },
    {
        name: 'Tools Tambahan',
